...
from reproducibility_blocks import print_payload, run_all_hypotheses


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run all E01 reproducibility blocks.")
...
if __name__ == "__main__":
    args = parse_args()
    print_payload(run_all_hypotheses(data_root=args.data_root, masks_root=args.masks_root, config_path=args.paths_config))
